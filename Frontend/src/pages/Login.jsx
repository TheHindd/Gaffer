  ...
  return (
    <div>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-50 to-white" /*style={{backgroundColor: '#F4F7FE'}}*/ >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="black" class="size-7 absolute center bottom-10 cursor-pointer" onClick={()=> navigate('/')}>
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
        </svg>  
       <div className="flex bg-white rounded-3xl shadow-lg overflow-hidden max-w-3xl w-250 h-120">
        ...
        <div className="flex flex-col justify-center p-8 w-1/2">
          ...
          <form>
            ...
            <button onClick={()=> navigate('/Dashboard')} className="w-full bg-blue-700 text-white py-2 rounded hover:bg-blue-500 mb-4">
              Log in
            </button>
          </form>
